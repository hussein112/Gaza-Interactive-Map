            ...
            onEnter: async () => {
                ...
                switch (currentId) {
                    ...
                    case "three":
                        ...
                        tl.add(await loadLocalSVGImage('khan-younis', 'Gaza-Interactive-Map/assets/khanyounis_refugee_camps.svg', [34.29204, 31.35317]));
                    ...
                    case "three-two":
                        ...
                        tl.add(await loadLocalSVGImage('rafah', 'Gaza-Interactive-Map/assets/rafah.svg', [34.242789, 31.308767]));
                        map.flyTo({
                    ...
                    case "three-three":
                        ...
                        // add the third image
                        tl.add(await loadLocalSVGImage('rafah-two', 'Gaza-Interactive-Map/assets/rafah_2.svg', [34.242789, 31.308767]));
                        setTimeout(() => {
                    ...
                    case "five":
                        ...
                        tl.add(await loadLocalSVGImage('south-one', 'Gaza-Interactive-Map/assets/south_1.svg', [34.27204, 31.23714]));
                        tl.add(addImageLayer("south-one", 5))
                        break;
                    case "five-two":
                        tl.add(await loadLocalSVGImage('south-two', 'Gaza-Interactive-Map/assets/south_2.svg', [34.27204, 31.23714]));
                        tl.add(addImageLayer("south-two", 5))
                        tl.add(removePreviousLayer("south-one", "icon-opacity"));
                        break;
                    case "five-three":
                        tl.add(await loadLocalSVGImage('south-three', 'Gaza-Interactive-Map/assets/south_3.svg', [34.270901, 31.235705]));
                    ...
                    case "seven":
                        ...
                        // tl.add(await loadLocalSVGImage('mawasi', 'Gaza-Interactive-Map/assets/south_3.svg', [34.270901, 31.235705]));
                        // tl.add(addImageLayer("mawasi", 5))
                        break;
                    case "seven-two":
                        tl.add(await loadLocalSVGImage('mawasi', 'Gaza-Interactive-Map/assets/mawasi.svg', [34.265655, 31.349355]));
                    ...
                    case "eleven":
                        ...
                        tl.add(await loadLocalSVGImage('mawasi-two', 'Gaza-Interactive-Map/assets/mawasi_2.svg', [34.300712, 31.377954]));
                    ...
                    case "fifteen":
                        ...
                        break;
                    case "sixteen":
                        tl.add(await loadLocalSVGImage('mawasi-three', 'Gaza-Interactive-Map/assets/mawasi_3.svg', [34.282923, 31.373260]));
                        ...
                        break;
                    case "seventeen":
                        tl.add(await loadLocalSVGImage('mawasi-four', 'Gaza-Interactive-Map/assets/mawasi_4.svg', [34.296442, 31.375787]));
                    ...
                    case "eighteen":
                        ...
                        tl.add(await loadLocalSVGImage('mawasi-five', 'Gaza-Interactive-Map/assets/mawasi_5.svg', [34.286353, 31.370217]));
                    ...
                    case "twentyeight":
                        ...
                        // ,
                        tl.add(await loadLocalSVGImage('mawasi-six', 'Gaza-Interactive-Map/assets/mawasi_6.svg', [34.244100, 31.334291]));
                    ...
                    case "twentynine":
                        ...
                        tl.add(await loadLocalSVGImage('mawasi-seven', 'Gaza-Interactive-Map/assets/mawasi_7.svg', [34.244100, 31.334291]));
                        tl.add(addImageLayer("mawasi-seven", 3)) 
                        break;
                    case "thirty":
                        tl.add(removePreviousLayer("mawasi-seven", 'icon-opacity'))
                        tl.add(await loadLocalSVGImage('mawasi-eight', 'Gaza-Interactive-Map/assets/mawasi_8.svg', [34.241040, 31.331591]));
