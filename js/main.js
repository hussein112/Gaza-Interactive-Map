            ...
            onEnter: async () => {
                ...
                switch (currentId) {
                    ...
                    case "two":
                        ...
                        // Show the Arrow
                        tl.add(await loadLocalImage('arrow', '/assets/Gaza-Interactive-Map/map_arrow_one.png', [34.40864, 31.45657]));
                        setTimeout(() => {
                    ...
                    case "two-three":
                        ...
                        tl.add(await loadLocalImage('arrow-2', '/assets/Gaza-Interactive-Map/map_arrow_two.png', [34.41148, 31.45489]));
                        setTimeout(() => {
                            tl.add(addImageLayer("arrow-2", 0.5))
                        }, 1000)

                        tl.add(await loadLocalImage('arrow-2-2', '/assets/Gaza-Interactive-Map/map_arrow_two_two.png', [34.30872, 31.32629]));
                        setTimeout(() => {
                    ...
                    case "two-five":
                        ...
                        // Show arrows 3
                        tl.add(await loadLocalImage('arrow-3', '/assets/Gaza-Interactive-Map/map_arrow_three.png', [34.26836, 31.28998]));
                    ...
                    case "three":
                        ...
                        tl.add(await loadLocalSVGImage('khan-younis', '/assets/Gaza-Interactive-Map/khanyounis_refugee_camps.svg', [34.29204, 31.35317]));
                    ...
                    case "three-two":
                        ...
                        tl.add(await loadLocalSVGImage('rafah', '/assets/Gaza-Interactive-Map/rafah.svg', [34.242789, 31.308767]));
                        map.flyTo({
                    ...
                    case "three-three":
                        ...
                        // add the third image
                        tl.add(await loadLocalSVGImage('rafah-two', '/assets/Gaza-Interactive-Map/rafah_2.svg', [34.242789, 31.308767]));
                        setTimeout(() => {
                    ...
                    case "three-four":
                        ...
                        // add the third image
                        tl.add(await loadLocalSVGImage('rafah-three', '/assets/Gaza-Interactive-Map/rafah_3.svg', [34.242789, 31.308767]));
                    ...
                    case "five":
                        ...
                        tl.add(await loadLocalSVGImage('south-one', '/assets/Gaza-Interactive-Map/south_1.svg', [34.27204, 31.23714]));
                        tl.add(addImageLayer("south-one", 5))
                        break;
                    case "five-two":
                        tl.add(await loadLocalSVGImage('south-two', '/assets/Gaza-Interactive-Map/south_2.svg', [34.27204, 31.23714]));
                        tl.add(addImageLayer("south-two", 5))
                        tl.add(removePreviousLayer("south-one", "icon-opacity"));
                        break;
                    case "five-three":
                        tl.add(await loadLocalSVGImage('south-three', '/assets/Gaza-Interactive-Map/south_3.svg', [34.270901, 31.235705]));
                    ...
                    case "seven":
                        ...
                        // tl.add(await loadLocalSVGImage('mawasi', '/assets/Gaza-Interactive-Map/south_3.svg', [34.270901, 31.235705]));
                        // tl.add(addImageLayer("mawasi", 5))
                        break;
                    case "seven-two":
                        tl.add(await loadLocalSVGImage('mawasi', '/assets/Gaza-Interactive-Map/mawasi.svg', [34.265655, 31.349355]));
                    ...
                    case "eleven":
                        ...
                        tl.add(await loadLocalSVGImage('mawasi-two', '/assets/Gaza-Interactive-Map/mawasi_2.svg', [34.300712, 31.377954]));
                    ...
                    case "fifteen":
                        ...
                        break;
                    case "sixteen":
                        tl.add(await loadLocalSVGImage('mawasi-three', '/assets/Gaza-Interactive-Map/mawasi_3.svg', [34.282923, 31.373260]));
                        ...
                        break;
                    case "seventeen":
                        tl.add(await loadLocalSVGImage('mawasi-four', '/assets/Gaza-Interactive-Map/mawasi_4.svg', [34.296442, 31.375787]));
                    ...
                    case "eighteen":
                        ...
                        tl.add(await loadLocalSVGImage('mawasi-five', '/assets/Gaza-Interactive-Map/mawasi_5.svg', [34.286353, 31.370217]));
                    ...
                    case "twentyeight":
                        ...
                        // ,
                        tl.add(await loadLocalSVGImage('mawasi-six', '/assets/Gaza-Interactive-Map/mawasi_6.svg', [34.244100, 31.334291]));
                    ...
                    case "twentynine":
                        ...
                        tl.add(await loadLocalSVGImage('mawasi-seven', '/assets/Gaza-Interactive-Map/mawasi_7.svg', [34.244100, 31.334291]));
                        tl.add(addImageLayer("mawasi-seven", 3)) 
                        break;
                    case "thirty":
                        tl.add(removePreviousLayer("mawasi-seven", 'icon-opacity'))
                        tl.add(await loadLocalSVGImage('mawasi-eight', '/assets/Gaza-Interactive-Map/mawasi_8.svg', [34.241040, 31.331591]));
